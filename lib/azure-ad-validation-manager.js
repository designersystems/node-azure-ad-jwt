...
function AzureActiveDirectoryValidationManager() {
     ...
     */
    self.requestSigningCertificates = function(tenantId, jwtSigningKeysLocation, cb) {
    ...
    self.verify = function(jwt, certificates, options, cb) {
        ...
        certificates.every(function(certificateObj) {

            // ensure we validate using the correct issuer
            options.issuer = certificateObj.issuer;

            var certificate = certificateObj.cert;
